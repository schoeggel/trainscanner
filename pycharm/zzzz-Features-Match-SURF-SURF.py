...
detect = cv2.xfeatures2d.SURF_create(700)
...
#bf = cv2.BFMatcher(cv2.NORM_HAMMING2, crossCheck= #wirft error wenn SURF detector kombiniert mit
...
dmode = 'SURF-SURF'
img4 = cv2.putText(img4, 'detect/compute: ' + dmode, (40, 80), 1, 6, (0, 0, 255), 1)
img4 = cv2.putText(img4, 'Keypoints:' + str((foundkp1,foundkp2)), (40, 160), 1, 6, (0, 0, 255), 1)
img4 = cv2.putText(img4, 'matches Limit: ' + str(n), (40, 240), 1, 6, (0, 0, 255), 1)
